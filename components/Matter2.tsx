...
function MatterJS() {
	...
	useEffect(() => {
		...
		// );
          ...
          // add bodies
    var cradle = Composites.newtonsCradle(70, 50, goodImg.length-1, 20, 200);
    World.add(world, cradle);
    for(var i=0; i <= goodImg.length-2; i++){
        cradle.bodies[i].render.sprite.texture= `/tech/${goodImg[i]}.png`;
        cradle.bodies[i].render.sprite.xScale= 0.5;
        cradle.bodies[i].render.sprite.yScale= 0.5;
    }
